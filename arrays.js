 ...
 for (i=0; i<arr.length; i++)
{
 ...
 } else if (Math.max(...max) === countN) {
   console.log ("Daugiausia yra raidžių N: " + countN)
 } else if (Math.max(...max) === countO) {
   console.log ("Daugiausia yra raidžių O: " + countO)
 } else if (Math.max(...max) === countP) {
   console.log ("Daugiausia yra raidžių P: " + countP)
 } else {
   console.log ("Kelių raidžių vienodos skaičius")
 } //kai vienodas skaičius neveikia */
